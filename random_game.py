...
def the_random_game():
    ...
    def rpsWins():
        ...
        while wins < 1 and lives > 0:  
            ...
            if result == "winner":
                ...
                wins += 1
                lives += 1
                print(player_name + ", you have " + str(lives) + " lives left!")
                print()
    ...
    def horse_game():
        ...
        while player_horse not in response:
            ...
            player_horse = input(Fore.LIGHTCYAN_EX + "Lucky[1], Speedy[2], Lightning[3], Slow Poke[4]: " + Style.RESET_ALL)
        ## Lucky
    ...
    def horseWINS():
        ...
        while wins < 1 and lives > 0:
            ...
            while result == "won":
                wins += 1
                print(Fore.LIGHTGREEN_EX + "Your horse won" + Style.RESET_ALL)
                print()
                break
    ...
    def cardPickup():
        ...
        while cardChoice not in cards:
            print(Fore.LIGHTMAGNETA_EX + "Thats not a card..." + Style.RESET_ALL)
            cardChoice = input("\nWhat card is in my hand?\n")
        ...
        while lives > 0 and wins < 1:
            if cardChoice == drop:
                ...
                print(Fore.LIGHTRED_EX + "\nThat is not my card." + Style.RESET_ALL)
                lives -= 1
                ...
                while cardChoice not in cards:
                    print(Fore.LIGHTRED_EX + "Thats not a card..." + Style.RESET_ALL)
                    cardChoice = input("What card is in my hand?\n")
                    if cardChoice in cards:
                        break
